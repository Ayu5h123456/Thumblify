                            ...
                            <div className='p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6'>
                                ...
                                <div className='space-y-5'>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <input type='text' value={title} onChange={(e) => setTitle(e.target.value)} maxLength={100} placeholder='e.g., 10 Tips for Better Sleep' className='w-full px-4 py-3 rounded-lg border border-white/12  bg-black/20  text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-gray-500' />
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <textarea value={additionalDetails} onChange={(e) => setAdditionalDetails(e.target.value)} rows={3} placeholder='Add any specific elements, mood, or style preferences...' className='w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6  text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-gray-500 resize-none' />
                                    </div>
                                </div>

                                {/* BUTTON */}
                                {!id && (
                                    <button onClick={handleGenerate} className='text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b from-gray-500 to-gray-600 hover:from-gray-700 disabled:cursor-not-allowed transition-colors'>
