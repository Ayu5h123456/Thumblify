        ...
        <>
            ...
            <div className='min-h-screen flex items-center justify-center'>
                <form onSubmit={handleSubmit} className='w-full sm:w-87.5 text-center bg-white/6 border border-white/10 rounded-2xl px-8'>
                    ...
                    {state !== 'login' && (
                        <div className='flex items-center mt-6 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-gray-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all '>
                    ...
                    <div className='flex items-center w-full mt-4 bg-white/5 ring-2 ring-white/10 focus-within:ring-gray-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all '>
                    ...
                    <div className=' flex items-center mt-4 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-gray-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all '>
                        <svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' fill='none' stroke='currentColor' className='text-white/75' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
                            {' '}
                    ...
                    <div className='mt-4 text-left'>
                        <button className='text-sm text-gray-400 hover:underline'>Forget password?</button>
                    </div>

                    <button type='submit' className='mt-2 w-full h-11 rounded-full text-white bg-gray-600 hover:bg-gray-500 transition '>
                    ...
                    <p onClick={() => setState((prev) => (prev === 'login' ? 'register' : 'login'))} className='text-gray-400 text-sm mt-3 mb-11 cursor-pointer'>
                        ...
                        <span className='text-gray-400 hover:underline ml-1'>click here</span>
                    </p>
                </form>
            </div>
        </>
