        ...
        <>
            ...
            >
                ...
                <div className='hidden md:flex items-center gap-8 transition duration-500'>
                    ...
                    <Link to='/generate' className='hover:text-gray-300 transition'>
                        Generate
                    </Link>
                    {isLoggedIn ? (
                        <Link to='/my-generation' className='hover:text-gray-300 transition'>
                            My Generations
                        </Link>
                    ) : (
                        <Link to='#' className='hover:text-gray-300 transition'>
                ...
                <div className='flex items-center gap-2'>
                    {isLoggedIn ? (
                        ...
                        <button onClick={() => navigate('/login')} className='hidden md:block px-6 py-2.5 bg-gray-600 hover:bg-gray-700 active:scale-95 transition-all rounded-full'>
                            Get Started
                        </button>
                    )}
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <button onClick={() => setIsOpen(false)} className='active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-gray-600 hover:bg-gray-700 transition text-white rounded-md flex'>
                    <XIcon />
                </button>
            </div>
        </>
